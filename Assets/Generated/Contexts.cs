...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, UnityEngine.GameObject>(
            ...
            (e, c) => ((ViewComponent)c).View));
    }
}

public static class ContextsExtensions {

    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithView(this GameContext context, UnityEngine.GameObject View) {
        return ((Entitas.EntityIndex<GameEntity, UnityEngine.GameObject>)context.GetEntityIndex(Contexts.View)).GetEntities(View);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
