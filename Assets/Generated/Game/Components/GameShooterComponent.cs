...
public partial class GameEntity {
    ...
    public void AddShooter(float newShootDelay, UnityEngine.GameObject newBulletPrefab, float newBulletSpeed, Sources.BulletType newBulletType, int newOneShotSize) {
